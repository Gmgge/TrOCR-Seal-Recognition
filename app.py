...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_img', default='test/test.jpg', type=str, help="img path or dir path")
    ...
    test_images = get_image_file_list(args.test_img)
    for one_image in test_images:
        t = time.time()
